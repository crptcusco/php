SELECT 'DROP PROCEDURE coor_cambio_add_edit' AS 'MENSAJE'; 
DROP PROCEDURE IF EXISTS coor_cambio_add_edit;
SELECT 'CREATE PROCEDURE coor_cambio_add_edit' AS 'MENSAJE';
DELIMITER $$ 
...
-- SELECT 'CALL coor_cambio_add_edit' AS '---------------------------- MENSAJE ------------------------'
-- ;
...
-- ;
-- SELECT * FROM coor_coordinacion_tipo_cambio ORDER BY id DESC LIMIT 3
-- ;
-- SELECT * FROM coor_coordinacion_tipo_cambio_history ORDER BY id DESC LIMIT 3
-- ;
