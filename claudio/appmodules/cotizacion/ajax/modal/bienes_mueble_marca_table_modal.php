...
/*
  ...
  desabilitar pruebas 
*/
$output = get_modals_bien_mueble_marca_tabla($input);
...
*/
// ------------------------------------------------ OUTPUT
$name = 'bienes-mueble-marca-tabla-ajax';
?>
...
<script>
 ...
 var tf_11 = setFilterGrid( "<?php echo $name ?>", settings );
</script>
...
function imprimir($row) {
  ...
  $row['codigos'] = $row['tipo_id'] . '-' . $row['marca_id'] . '-0';
  echo '
