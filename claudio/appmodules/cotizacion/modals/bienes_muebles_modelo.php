<?php
$group = 'co_bienes_field_sub_categoria_mueble_modelo_modal'
?>

<div id="co_bienes_field_sub_categoria_mueble_modelo_modal" class="reveal-modal" data-reveal>
  <h2>Modelos</h2>
  ...
  <input id="<?php prefix('marca_id') ?>"  value="0" type="hidden">
