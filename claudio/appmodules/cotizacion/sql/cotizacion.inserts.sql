SELECT '---------------------- Inserts ----------------------' AS 'MENSAJE';

-- -------------------------------- ini general
INSERT INTO co_servicio_tipo (id, nombre, info_create_user)
VALUES 
(1, 'Valuación Inmuebles', 1),
(2, 'Valuación Muebles', 1),
(3, 'Valuación Muebles e Inmuebles', 1)
;
INSERT INTO co_servicio_tipo_history (servicio_tipo_id, nombre, info_create_user)
VALUES 
(1, 'Valuación Inmuebles', 1),
(2, 'Valuación Muebles', 1),
(3, 'Valuación Muebles e Inmuebles', 1)
;
INSERT INTO co_estado (nombre, info_create_user)
VALUES 
('Pendiente', 1),
('En Espera', 1),
('Aprobado', 1),
...
INSERT INTO co_vendedor (id, nombre, telefono, correo, info_create_user)
VALUES (1, 'Milagros Custodio', '999 999 999', 'email@gmail.com', 1)
;
INSERT INTO co_vendedor_history (vendedor_id, nombre, telefono, correo, info_status, info_create_user)
VALUES (1, 'Milagros Custodio', '999 999 999', 'email@gmail.com', 1, 1)
;

-- -------------------------------- end involucrados
-- -------------------------------- ini cotizacion

-- INSERT INTO co_cotizacion 
--        ( 
--        codigo, actualizacion, servicio_tipo_id, estado_id, adjunto,
...
--        (
--        1, 0, 1, 1, 'archivo.sql',
--        '2015-02-01', '2015-02-01', '2015-02-01',1,
--        1
--        )
-- ;
...
INSERT INTO co_involucrado_documento_tipo(id, nombre, info_create_user)
VALUES (1,'DNI',1)
;
INSERT INTO co_involucrado_documento_tipo_history(documento_tipo_id, nombre, info_create_user)
VALUES (1,'DNI',1)
;
INSERT INTO co_involucrado_rol(id, nombre)
VALUES 
(1,'Cliente'),
(2,'Solicitante'),
(3,'Propietario')
;
INSERT INTO co_involucrado_clasificacion(id, nombre, info_create_user)
VALUES 
(1, 'Particular', 1),
(2, 'Banco', 1),
(3, 'Estatal', 1)
;
INSERT INTO co_involucrado_clasificacion_history(clasificacion_id, nombre, info_create_user)
VALUES 
(1, 'Particular',1),
(2, 'Banco',1),
(3, 'Estatal',1)
;
INSERT INTO co_involucrado_actividad(id, nombre, info_create_user)
VALUES 
(1,'Minera',1),
(2,'Alimentos',1),
(3,'Construcción',1)
;
INSERT INTO co_involucrado_actividad_history(actividad_id, nombre, info_create_user)
VALUES 
(1,'Minera',1),
(2,'Alimentos',1),
(3,'Construcción',1)
;
INSERT INTO co_involucrado_grupo(id, nombre, info_create_user)
VALUES (1, 'Grupo Romero',1)
;
INSERT INTO co_involucrado_grupo_history(grupo_id, nombre, info_create_user)
VALUES (1, 'Grupo Romero',1)
;
-- INSERT INTO co_involucrado_natural(id, nombre, documento_tipo_id, documento, direccion, telefono, correo, info_create_user)
-- VALUES (1, 'Claudio Rodriguez Oré', 1, '44028610', 'Av. CantoBello 289', '977 270 941','profins@gmail.com',1)
-- ;
-- INSERT INTO co_involucrado_natural_history(natural_id, nombre, documento_tipo_id, documento, direccion, telefono, correo, info_create_user)
-- VALUES (1, 'Claudio Rodriguez Oré', 1, '44028610', 'Av. CantoBello 289', '977 270 941','profins@gmail.com',1)
-- ;
-- INSERT INTO co_involucrado_juridica(id, clasificacion_id, actividad_id, grupo_id, nombre, ruc, direccion, telefono, info_create_user)
-- VALUES 
-- (1, 1, 1, 0, 'Sauses S.A.C', '123456', 'Avenida Cantar 298', '999 999 999', 1 ),
-- (2, 1, 1, 0, 'Viñedos S.A.C', '654321', 'Jiron Tux 892', '(056) 777 7777', 1 )
-- ; 
...
-- VALUES 
-- (1, 1, 1, 0, 'Sauses S.A.C' , '123456', 'Av. Cantar 298', '999 999 999'   , 1 ),
-- (2, 1, 1, 0, 'Viñedos S.A.C', '654321', 'Jiron Tux 892' , '(056) 777 7777', 1 )
-- ; 
-- INSERT INTO co_involucrado_contacto(id, juridica_id, nombre, cargo, telefono, correo, info_create_user)
-- VALUES 
-- (1, 1, 'Luisa Primtem'     , 'Jefe de ventas', '999 999 999', 'correo@gmail.com', 1),
-- (2, 2, 'Roberto Talaverano', 'Soporte'       , '666 666 666', 'correo@gmail.com', 1)
-- ;
-- INSERT INTO co_involucrado_contacto_history(contacto_id, juridica_id, nombre, cargo, telefono, correo, info_create_user)
-- VALUES 
-- (1, 1, 'Luisa Primtem'     , 'Jefe de ventas', '999 999 999', 'correo@gmail.com', 1),
-- (2, 2, 'Roberto Talaverano', 'Soporte'       , '666 666 666', 'correo@gmail.com', 1)

-- ;
-- INSERT INTO co_involucrado(id, info_create_user, cotizacion_id, rol_id, persona_tipo, persona_id, contacto_id)
-- VALUES 
-- (1, 1, 1, 1, 'Juridica', 1, 1),
-- (2, 1, 1, 2, 'Juridica', 2, 2),
-- (3, 1, 1, 3, 'Natural' , 1, 0)
-- ; 
-- INSERT INTO ()
-- VALUES ()
...
-- INSERT INTO co_mensaje (
--        cotizacion_id, estado_id, mensaje, fecha_proxima, proxima,
--        info_create_user)
-- VALUES (
--        1, 1,'para consultar gerencia', '2015-02-11', 0,
--        1)
-- ;
...
INSERT INTO co_igv(monto)
VALUES (0.18)
;
INSERT INTO co_moneda(nombre,simbolo,monto)
VALUES 
('Soles','S/.',1.0),
('Dolar','$',3.0741),
('Euros','&euro;',3.4691)
...
INSERT INTO co_perito( id, nombre, telefono, correo,
       info_create_user )
VALUES
( 1, 'Marco Muga', '999 999 999', 'correo@gmail.com', 1),
( 2, 'Miguel Rubiños', '999 999 999', 'correo@gmail.com', 1),
( 3, 'Angel Chavez', '999 999 999', 'correo@gmail.com', 1),
( 4, 'Julio Arbizu', '999 999 999', 'correo@gmail.com', 1)
;
INSERT INTO co_perito_history( perito_id, nombre, telefono, correo,
       info_create_user )
VALUES 
( 1, 'Marco Muga', '999 999 999', 'correo@gmail.com', 1),
( 2, 'Miguel Rubiños', '999 999 999', 'correo@gmail.com', 1),
...
( 4, 'Julio Arbizu', '999 999 999', 'correo@gmail.com', 1)
;
-- INSERT INTO co_pago( id, cotizacion_id,
--         fecha,
...
-- VALUE ( 1, 1,
--          '2015-02-23 00:00:00', 
-- 	 0.18, 'sin', 500.00, 590.00,
-- 	 3.88, 2,
--          1)
-- ;
-- INSERT INTO co_pago_history( pago_id, cotizacion_id,
--         fecha,
-- 	total_igv, total_igv_de, total_monto, total_monto_igv,
-- 	total_cambio, total_moneda_id, 
--         info_create_user )
...
-- ;
-- ----------
-- INSERT INTO co_pago_has_perito( id, pago_id, perito_id,
--        monto, igv, total, cambio, moneda_id,
--        info_create_user)
-- VALUE ( 1, 1, 1,
--       	200.0, 0.0, 200.0, 3.6, 2, 
--         1)
-- ;
-- INSERT INTO co_pago_has_perito_history( pago_has_perito_id, pago_id, perito_id,
--        monto, igv, total, cambio, moneda_id,
--        info_create_user)
-- VALUE ( 1, 1, 1,
--       	200.0, 0.0, 200.0, 3.6, 2, 
...
INSERT INTO co_bien_categoria (id, nombre) VALUES
(1, 'Mueble'),
(2, 'Inmueble'),
(3, 'Masivos')
;
INSERT INTO co_bien_sub_categoria (categoria_id, id, nombre, info_create_user) VALUES
(1, 1, 'Maquinaria', 1),
(1, 2, 'Vehiculo', 1),
(1, 3, 'Equipo', 1),
(1, 4, 'Otros', 1),
(2, 5, 'Casa', 1),
(2, 6, 'Departamento', 1),
(2, 7, 'Local Industrial', 1),
(2, 8, 'Local Comercial', 1),
(2, 9, 'Terreno', 1),
(3,11, 'Masivos', 1)
;
INSERT INTO co_bien_sub_categoria_history (categoria_id, sub_categoria_id, nombre, info_create_user) VALUES
(1, 1, 'Maquinaria', 1),
(1, 2, 'Vehiculo', 1),
(1, 3, 'Equipo', 1),
(1, 4, 'Otros', 1),
...
(3,11, 'Masivos', 1)
;
INSERT INTO  co_bien_muebles_clasificacion(id, sub_categoria_id, tipo_id, marca_id, modelo_id, nombre, info_create_user) VALUES
(1, 1, 1, 0, 0, 'Excavadora', 1),
(2, 1, 1, 1, 0, 'Hyunday', 1),
(3, 1, 1, 1, 1, 'Robex 305LC-7', 1),
(4, 2, 2, 0, 0, 'Automovil', 1),
(5, 2, 2, 1, 0, 'Toyota', 1),
(6, 2, 2, 1, 1, 'Corola G 1.8 GSL', 1),
(7, 4, 3, 0, 0, 'Obra de Arte', 1)
;
INSERT INTO  co_bien_muebles_clasificacion_history(clasificacion_id, sub_categoria_id, tipo_id, marca_id, modelo_id, nombre, info_create_user) VALUES
(1, 1, 1, 0, 0, 'Excavadora', 1),
(2, 1, 1, 1, 0, 'Hyunday', 1),
(3, 1, 1, 1, 1, 'Robex 305LC-7', 1),
(4, 2, 2, 0, 0, 'Automovil', 1),
...
(7, 4, 3, 0, 0, 'Obra de Arte', 1)
;
INSERT INTO co_bien_inmuebles_ubigeo(departamento_id, provincia_id, distrito_id, nombre) VALUES
('1', '0', '0', 'AMAZONAS'),
('1', '1', '0', 'CHACHAPOYAS'),
('1', '1', '1', 'CHACHAPOYAS'),
('1', '1', '2', 'ASUNCION'),
...
('25', '4', '1', 'PURUS')
;
-- INSERT INTO co_bien_mueble (id, cotizacion_id, sub_categoria_id, tipo_id, marca_id, modelo_id, descripcion, orden, info_create_user) VALUES
-- (1, 1, 2, 2, 1, 1, "Ejemplo", 1, 1)
-- ;
-- INSERT INTO co_bien_mueble_history (mueble_id, cotizacion_id, sub_categoria_id, tipo_id, marca_id, modelo_id, descripcion, orden, info_create_user) VALUES
-- (1, 1, 2, 2, 1, 1, "Ejemplo", 1, 1)
-- ;
-- INSERT INTO co_bien_inmueble (id, cotizacion_id, sub_categoria_id, departamento_id, provincia_id, distrito_id, direccion , descripcion, orden, info_create_user) VALUES
-- (1, 1, 5, "15", "1", "32", "Av Ejemplo", "DES ejemplo", 2, 1)
-- ;
-- INSERT INTO co_bien_inmueble_history (inmueble_id, cotizacion_id, sub_categoria_id, departamento_id, provincia_id, distrito_id, direccion, descripcion, orden, info_create_user) VALUES
-- (1, 1, 5, "15", "1", "32", "Av Ejemplo", "DES ejemplo", 2, 1)
-- ;
-- INSERT INTO co_bien_mazivo (id, cotizacion_id, sub_categoria_id, direccion, orden, info_create_user) VALUES
-- (1, 1, 11, "documento-2015-10-01.pdf", 3, 1)
-- ;
-- INSERT INTO co_bien_mazivo_history (mazivo_id, cotizacion_id, sub_categoria_id, direccion, orden, info_create_user) VALUES
-- (1, 1, 11, "documento-2015-10-01.pdf", 3, 1)
-- ;
-- -------------------------------- end bienes
