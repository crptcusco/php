...
SELECT 'DROP FUNCTION co_bien_marca_save' AS 'MENSAJE'; 
DROP FUNCTION IF EXISTS co_bien_marca_save;
SELECT 'CREATE FUNCTION co_bien_marca_save' AS 'MENSAJE';
DELIMITER $$ 
...
--     @marca_id=6,
--     @sub_categoria_id=1,
--     @nombre='test marca generate update',
--     @info_status=0, 
--     @user_id=2
-- ;
...
-- ;
-- SELECT 'SELECT co_bien_marca_save' AS '---------------------------- MENSAJE ------------------------';
