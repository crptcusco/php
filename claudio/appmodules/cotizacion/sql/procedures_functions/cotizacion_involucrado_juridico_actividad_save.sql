...
SELECT 'DROP FUNCTION co_involucrado_juridico_actividad_save' AS 'MENSAJE'; 
DROP FUNCTION IF EXISTS co_involucrado_juridico_actividad_save;
SELECT 'CREATE FUNCTION co_involucrado_juridico_actividad_save' AS 'MENSAJE';
DELIMITER $$ 
...
-- ;
-- SELECT * FROM co_involucrado_actividad
-- ;
-- SELECT * FROM co_involucrado_actividad_history
-- ;
-- SELECT 'SELECT co_involucrado_juridico_actividad_save' AS '---------------------------- MENSAJE ------------------------';
