...
SELECT 'DROP FUNCTION co_involucrado_juridico_grupo_save' AS 'MENSAJE'; 
DROP FUNCTION IF EXISTS co_involucrado_juridico_grupo_save;
SELECT 'CREATE FUNCTION co_involucrado_juridico_grupo_save' AS 'MENSAJE';
DELIMITER $$ 
...
-- ;
-- SELECT * FROM co_involucrado_grupo
-- ;
-- SELECT * FROM co_involucrado_grupo_history
-- ;
-- SELECT 'SELECT co_involucrado_juridico_grupo_save' AS '---------------------------- MENSAJE ------------------------';
