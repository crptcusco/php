<?php
 $group= 'co_search_bienes';
?>
<div class="row">
  <div class="small-2 columns">
    <div class="row">
      <div class="small-2 columns">
	<input id="<?php prefix( 'categoria_ninguno_radio' ) ?>" class="<?php prefix( 'categoria_radio' ) ?>" name="<?php prefix( 'categoria_radio' ) ?>" type="radio"  checked  >
      </div>
      <div class="small-10 columns">
	<label for="<?php prefix( 'categoria_ninguno_radio' ) ?>">Ninguno</label>
      </div>      
    </div>
    <div class="row">
      <div class="small-2 columns">
	<input id="<?php prefix( 'categoria_mueble_radio' ) ?>" class="<?php prefix( 'categoria_radio' ) ?>" name="<?php prefix( 'categoria_radio' ) ?>" type="radio" >
      </div>
      <div class="small-10 columns">
  ...
  <div class="small-2 columns">
    <div id="<?php prefix( 'categoria_mueble_content' ) ?>" class="<?php prefix( 'categoria_content' ) ?>" style="display:none">
  ...
  <div class="small-8 columns">
    <div id="<?php prefix( 'sub_categoria_muebles_content' ) ?>"  class="<?php prefix( 'sub_categoria_content' ) ?>" style="display:none">
	...
	<div class="small-9 columns">
	  <select id="<?php prefix( 'sub_categoria_inmueble_distrito' ) ?>" class="chosen-select">
	    <option value="1"></option>
	  </select>
	</div>
      </div>
