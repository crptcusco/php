<div class="row">
  ...
  <div class="small-3 columns">
     <button class="button tiny secondary" id="co_fecha_solicitud_clear">Limpiar</button>
  </div>
</div>
...
<div class="row">
  ...
  <div class="small-3 columns">
     <button class="button tiny secondary" id="co_fecha_envio_cliente_clear">Limpiar</button>
  </div>
</div>
...
<div class="row">
  ...
  <div class="small-3 columns">
     <button class="button tiny secondary" id="co_fecha_finalizado_clear">Limpiar</button>
  </div>
</div>
