$(document).ready(function () {
    ...
    //EVENTOS
    //$("#casa_tipo_cultivo_trigger_add").on("click", function(e) {
    //    select_tipo_cultivo_modal(0);
    //});
    //$("#modal_ta_casa_tipo_cultivo_save").on("click", function(e) {
...
//        var enviar = {
//            'nombre': $('#modal_ta_casa_tipo_cultivo_nombre').val(),
//        }
//    // console.log(enviar);
//    $.ajax({
//        type: "POST",
//        data: enviar,
//        url: '../ajax/save2/casa_tipo_cultivo.php',
//        success: function(data) {
//            $('#modal_ta_casa_tipo_cultivo_nombre').val('');
//            if (data.trim() == '') {
//                select_tipo_cultivo_load();
//            } else {
//                alert(data);
