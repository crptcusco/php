...
# INSERTAR OBJETO
    public function set($nueva_casa_data = array()) {             
        ...
        //INSERCION DE DATOS
        $this->query = "INSERT INTO t_departamento (proyecto_id,informe_id,cliente_id,propietario_id,solicitante_id, ubicacion, tasacion_fecha, ubi_departamento_id, ubi_provincia_id,ubi_distrito_id,mapa_latitud, mapa_longitud, zonificacion, piso_cantidad, piso_ubicacion, departamento_tipo_id , terreno_area, terreno_valorunitario, edificacion_area ,valor_comercial, valor_ocupada, estacionamiento_cantidad, areas_complementarias , tipo_cambio, observacion, ruta_informe ,usuario_registro_id,fecha_registro) VALUES('$proyecto_id','$informe_id','$cliente_id_bd','$propietario_id_bd', '$solicitante_id_bd', '$ubicacion',STR_TO_DATE('$tasacion_fecha','%Y-%m-%d'), '$ubi_departamento_id', '$ubi_provincia_id','$ubi_distrito_id', '$mapa_latitud','$mapa_longitud','$zonificacion','$piso_cantidad', '$piso_ubicacion', '$departamento_tipo_id', '$terreno_area','$terreno_valorunitario', '$edificacion_area','$valor_comercial', '$valor_ocupada', '$estacionamiento_cantidad', '$areas_complementarias', '$tipo_cambio','$observacion','$ruta_informe','$usuario_registro_id',NOW());";
