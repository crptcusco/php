...
class LocalComercial extends DBAbstractModel {
############################### PROPIEDADES ################################
...
# OBTENER OBJETO
    public function get($id = '') {
        ...
        from t_local_comercial where id = $id;";
        $this->rows = null;
...
# INSERTAR OBJETO
    public function set($nueva_casa_data = array()) {             
        ...
        //INSERCION DE DATOS
        $this->query = "
        INSERT INTO t_local_comercial (proyecto_id,informe_id,cliente_id,propietario_id,solicitante_id,
        ubicacion, tasacion_fecha, ubi_departamento_id, ubi_provincia_id,ubi_distrito_id,
        mapa_latitud, mapa_longitud, zonificacion, piso_cantidad, vista_local_id ,
        terreno_area, terreno_valorunitario, edificacion_area ,valor_comercial, valor_ocupada,
        ...
        '$ubicacion',STR_TO_DATE('$tasacion_fecha','%Y-%m-%d'), '$ubi_departamento_id', '$ubi_provincia_id','$ubi_distrito_id',
        '$mapa_latitud','$mapa_longitud','$zonificacion','$piso_cantidad', '$vista_local_id',
        '$terreno_area','$terreno_valorunitario', '$edificacion_area','$valor_comercial', '$valor_ocupada',
        ...
        $this->mensaje = 'Tasacion de Local Comercial agregado exitosamente';
    }
...
#LISTAR OBJETO
    public function listar() {
        $this->query = "select * from t_local_comercial ";
        $this->get_results_from_query();
        return $this->rows;
    }
