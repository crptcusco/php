...
class LocalIndustrial extends DBAbstractModel {
############################### PROPIEDADES ################################
...
# OBTENER OBJETO
    public function get($id = '') {
        ...
        from t_local_industrial where id = $id;";
        $this->rows = null;
...
# INSERTAR OBJETO
    public function set($nueva_casa_data = array()) {             
        ...
        //INSERCION DE DATOS
        $this->query = "
        INSERT INTO t_local_industrial (proyecto_id,informe_id,cliente_id,propietario_id,solicitante_id,
        ubicacion, tasacion_fecha, ubi_departamento_id, ubi_provincia_id,ubi_distrito_id,
        mapa_latitud, mapa_longitud, zonificacion, piso_cantidad, 
        ...
        $this->mensaje = 'Tasacion de LOCAL INDUSTRIAL agregado exitosamente';
    }
