...
# Traer datos de un terreno
    ...
    public function get($id = '') {
        ...
        fabricacion_anio, valor_similar_nuevo, valor_comercial, tipo_cambio, observacion, ruta_informe 
...
# NUEVO TERRENO
    public function set($nuevo_terreno_data = array()) {             
        ...
        //INSERCION DE DATOS
        $this->query = "
        INSERT INTO t_maquinaria (proyecto_id,informe_id,cliente_id,propietario_id,solicitante_id,ubicacion, tasacion_fecha, maquinaria_tipo_id, maquinaria_marca_id, maquinaria_modelo_id,fabricacion_anio,valor_similar_nuevo, valor_comercial, tipo_cambio, observacion, ruta_informe ,usuario_registro_id,fecha_registro) VALUES('$proyecto_id','$informe_id','$cliente_id_bd','$propietario_id_bd', '$solicitante_id_bd', '$ubicacion',STR_TO_DATE('$tasacion_fecha','%Y-%m-%d'), '$maquinaria_tipo_id','$maquinaria_marca_id' ,'$maquinaria_modelo_id','$fabricacion_anio','$valor_similar_nuevo', '$valor_comercial','$tipo_cambio','$observacion','$ruta_informe','$usuario_registro_id',NOW());";

        //print_r($this->query);
        //die();

        $this->execute_single_query();
        $this->mensaje = 'Tasacion de Maquinaria Registrada Exitosamente';
    }
