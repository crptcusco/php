...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_em_casa_dep
$$
CREATE PROCEDURE migrate_em_casa_dep()
BEGIN
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_em_casa_pro
$$
CREATE PROCEDURE migrate_em_casa_pro()
BEGIN
   DECLARE done INT DEFAULT FALSE;
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_em_casa_dis
$$
CREATE PROCEDURE migrate_em_casa_dis()
BEGIN
   DECLARE done INT DEFAULT FALSE;
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_t_casa_dep
$$
CREATE PROCEDURE migrate_t_casa_dep()
BEGIN
   DECLARE done INT DEFAULT FALSE;
   DECLARE dic_dep_id, ubi_dep_id  BIGINT;
   DECLARE cur1 CURSOR
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_t_casa_pro
$$
CREATE PROCEDURE migrate_t_casa_pro()
BEGIN
   DECLARE done INT DEFAULT FALSE;
   DECLARE dic_pro_id, ubi_pro_id  BIGINT;
   DECLARE cur1 CURSOR
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_t_casa_dis
$$
CREATE PROCEDURE migrate_t_casa_dis()
BEGIN
   DECLARE done INT DEFAULT FALSE;
   DECLARE dic_dis_id, ubi_dis_id  BIGINT;
   DECLARE cur1 CURSOR
