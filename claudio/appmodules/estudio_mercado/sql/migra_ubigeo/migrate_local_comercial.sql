...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_em_local_comercial_dep
$$
CREATE PROCEDURE migrate_em_local_comercial_dep()
BEGIN
   DECLARE done INT DEFAULT FALSE;
   DECLARE dic_dep_id, ubi_dep_id  BIGINT;
   DECLARE cur1 CURSOR
      FOR SELECT DISTINCT ubi_departamento_id
      FROM em_local_comercial; -- OK     
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_em_local_comercial_pro
$$
CREATE PROCEDURE migrate_em_local_comercial_pro()
BEGIN
   DECLARE done INT DEFAULT FALSE;
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_em_local_comercial_dis
$$
CREATE PROCEDURE migrate_em_local_comercial_dis()
BEGIN
   DECLARE done INT DEFAULT FALSE;
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_t_local_comercial_dep
$$
CREATE PROCEDURE migrate_t_local_comercial_dep()
BEGIN
   DECLARE done INT DEFAULT FALSE;
   DECLARE dic_dep_id, ubi_dep_id  BIGINT;
   DECLARE cur1 CURSOR
      FOR SELECT DISTINCT ubi_departamento_id
      FROM t_local_comercial; -- OK     
   DECLARE CONTINUE HANDLER
      FOR NOT FOUND SET done = TRUE;
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_t_local_comercial_pro
$$
CREATE PROCEDURE migrate_t_local_comercial_pro()
BEGIN
   DECLARE done INT DEFAULT FALSE;
   DECLARE dic_pro_id, ubi_pro_id  BIGINT;
   DECLARE cur1 CURSOR
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_t_local_comercial_dis
$$
CREATE PROCEDURE migrate_t_local_comercial_dis()
BEGIN
   DECLARE done INT DEFAULT FALSE;
   DECLARE dic_dis_id, ubi_dis_id  BIGINT;
   DECLARE cur1 CURSOR
