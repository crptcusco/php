...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_em_terreno_dep
$$
CREATE PROCEDURE migrate_em_terreno_dep()
BEGIN
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_em_terreno_pro
$$
CREATE PROCEDURE migrate_em_terreno_pro()
BEGIN
   DECLARE done INT DEFAULT FALSE;
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_em_terreno_dis
$$
CREATE PROCEDURE migrate_em_terreno_dis()
BEGIN
   DECLARE done INT DEFAULT FALSE;
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_t_terreno_dep
$$
CREATE PROCEDURE migrate_t_terreno_dep()
BEGIN
   DECLARE done INT DEFAULT FALSE;
   DECLARE dic_dep_id, ubi_dep_id  BIGINT;
   DECLARE cur1 CURSOR
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_t_terreno_pro
$$
CREATE PROCEDURE migrate_t_terreno_pro()
BEGIN
   DECLARE done INT DEFAULT FALSE;
   DECLARE dic_pro_id, ubi_pro_id  BIGINT;
   DECLARE cur1 CURSOR
...
-- ------------------------------------------
DROP PROCEDURE IF EXISTS migrate_t_terreno_dis
$$
CREATE PROCEDURE migrate_t_terreno_dis()
BEGIN
   DECLARE done INT DEFAULT FALSE;
   DECLARE dic_dis_id, ubi_dis_id  BIGINT;
   DECLARE cur1 CURSOR
