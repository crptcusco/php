...
require_once RUTA.'modelo/tasacion_casa.php';
...
<body>
    <div class="row">
        <form action="../controlador/tasacion_casa.php" method="POST" data-abide>
            <div data-abide-error class="alert callout" style="display: none;">
                <p><i class="fi-alert"></i> Hay Algunos Errores en tu Tasacion</p>
            </div>
            <div class="large-12 columns">
                <h3><a href="../index.php" class="button basic"> Volver al Inicio </a>
                    ...
                    Registro de Tasaciones de Casas</h3>
                </div>
            </div>
            <div class="row">
                <div class="large-6 columns">
                    ...
                    <div class="row">
                        <div class="medium-12 columns" id="ubicacion">
                            <label>Ubicacion
                                <input type="text" name="ubicacion"  placeholder="Ubicacion de la Casa" required>
                            </label>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="large-6 columns">
                    <div class="row">
                        <div id="combo_ta_Casa_zonificacion" class="medium-6 columns">
                    ...
                    <div class="row">
                        <div class="medium-6 columns">
                            <label>Tipo de Cambio
                                <input type="number" class="division" step="any" id="tipo_cambio" name="tipo_cambio" required pattern="number" >
                            </label>
                        </div>
                        <div class="medium-6 columns">
                    ...
                    <div class="row">
                        <div class="medium-6 columns">
                            <label>Cantidad de Pisos
                                <input type="number" class="division" step="any" id="piso_cantidad" name="piso_cantidad" required pattern="number" >
                            </label>
                        </div>
                        <div class="medium-6 columns">
                            <label>Area de Edificacion
                                <input type="number" class="division" step="any" id="edificacion_area" name="edificacion_area" required pattern="number" >
                            </label>
                        </div>
                    </div>
                    <div class="row">
    ...
    <div class="reveal" id="modal_ta_Casa_tipo_cultivo" data-reveal>
        <br>
        <h3>Nuevo Tipo de Cultivo</h3>
        <input id="modal_ta_Casa_tipo_cultivo_nombre" type="text" value="">
        <button id="modal_ta_Casa_tipo_cultivo_save" class="button" data-close>Guardar</button>
        <button id="close_modal_ta_Casa_cultivo_tipo" class="close-button" data-close aria-label="Close modal" type="button">
    ...
    <script type="text/javascript" src="../js/tasacion_casa.js"></script>
