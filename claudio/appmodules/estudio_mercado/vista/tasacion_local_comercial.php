...
//require_once RUTA.'modelo/tasacion_local_comercial.php';
...
<head>
    ...
    <title>Registro de Local Comercial</title>
...
<body>
    <div class="row">
        <form action="../controlador/tasacion_local_comercial.php" method="POST" data-abide>
            ...
            <div class="large-12 columns">
                <h3><a href="../index.php" class="button basic"> Volver al Inicio </a>
                    ...
                    Registro de Tasaciones de LOCAL COMERCIAL</h3>
                </div>
            </div>
            <div class="row">
                ...
                <div class="large-6 columns">
                    ...
                    <div class="row">
                        <div class="medium-6 columns">
                            <label>Vista Local
                                <select name="vista_local_id" id="vista_local_id" required>
    ...
    <script type="text/javascript" src="../js/tasacion_local_comercial.js"></script>
