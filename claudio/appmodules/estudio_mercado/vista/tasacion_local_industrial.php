...
<head>
    ...
    <title>Registro de LOCAL INDUSTRIAL</title>
...
<body>
    <div class="row">
        <form action="../controlador/tasacion_local_industrial.php" method="POST" data-abide>
            ...
            <div class="large-12 columns">
                <h3><a href="../index.php" class="button basic"> Volver al Inicio </a>
                    ...
                    Registro de Tasaciones de LOCAL INDUSTRIAL</h3>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="row">
                        <div class="medium-6 columns">
                            <label>Areas complementarias
                                <select id="areas_complementarias" name="areas_complementarias" required>
    ...
    <script type="text/javascript" src="../js/tasacion_local_industrial.js"></script>
