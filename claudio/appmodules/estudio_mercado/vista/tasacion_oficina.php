...
<body>
    <div class="row">
        <form action="../controlador/tasacion_oficina.php" method="POST" data-abide>
            <div data-abide-error class="alert callout" style="display: none;">
                <p><i class="fi-alert"></i> Hay Algunos Errores en tu Registro.</p>
            </div>
            <div class="large-12 columns">
                <h3><a href="../index.php" class="button basic"> Volver al Inicio </a>
                    ...
                    Registro de Tasaciones de Oficinas</h3>
                </div>
            </div>
            <div class="row">
                ...
                <div class="large-6 columns">
                    ...
                    <div class="row">
                        ...
                        <div id="combo_ta_departamento_tipo_departamento" class="medium-6 columns">
                            <label>Oficina Tipo :</label>
                            <select data-placeholder="Selecciona un Tipo  de Departamento ..." class="chosen-select" id="tasacion_departamento_tipo_id" name="tasacion_departamento_tipo_id" >
                                <option value="0"></option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="medium-6 columns" id="row_piso_cantidad">
                            <label>Cantidad de Pisos
                                <input type="number" step="any" id="piso_cantidad" name="piso_cantidad" pattern="number" >
                            </label>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="medium-6 columns" id="row_areas_complementarias">
                        ...
                        <div class="medium-6 columns" id="row_estacionamiento">
                            <label>Cantidad de Estacionamientos
                                <input type="number"  step="any" id="estacionamiento_cantidad" name="estacionamiento_cantidad" pattern="number" >
                            </label>
                        </div>
                    </div>
    ...
    <script type="text/javascript" src="../js/tasacion_oficina.js"></script>
