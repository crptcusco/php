...
<body>
    <div class="row">
        <form action="../controlador/tasacion_terreno.php" method="POST" data-abide>
            ...
            <div class="large-12 columns">
                <h3><a href="../index.php" class="button basic"> Volver al Inicio </a>
                    ...
                    Registro de Tasaciones de Terrenos</h3>
                </div>
            </div>
            <div class="row">
                ...
                <div class="large-6 columns">
                    <div class="row">
                        ...
                        <div id="combo_ta_terreno_tipo_cultivo" class="medium-6 columns">
                            <label>Tipo Cultivo : 
                                <a data-open="modal_ta_terreno_tipo_cultivo" id="terreno_tipo_cultivo_trigger_add">Nuevo Tipo Cultivo</a>
                            </label>
                            <select data-placeholder="Selecciona un tipo de Cultivo ..." class="chosen-select" id="tasacion_tipo_cultivo_id" name="tasacion_tipo_cultivo_id" required>
                                <option value="0"></option>
                            </select>
                        </div>
                    </div>
    ...
    <div class="reveal" id="modal_ta_terreno_tipo_cultivo" data-reveal>
        <br>
        <h3>Nuevo Tipo de Cultivo</h3>
        <input id="modal_ta_terreno_tipo_cultivo_nombre" type="text" value="">
        <button id="modal_ta_terreno_tipo_cultivo_save" class="button" data-close>Guardar</button>

        <button id="close_modal_ta_terreno_cultivo_tipo" class="close-button" data-close aria-label="Close modal" type="button">
    ...
    <script type="text/javascript" src="../js/tasacion_terreno.js"></script>
