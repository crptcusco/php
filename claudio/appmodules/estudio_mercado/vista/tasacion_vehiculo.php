...
<body>
    <div class="row">
        <form action="../controlador/tasacion_vehiculo.php" method="POST" data-abide>
            ...
            <div class="large-12 columns">
                <h3><a href="../index.php" class="button basic"> Volver al Inicio </a>
                    ...
                    Registro de Tasaciones de VEHICULOS</h3>
                </div>
            </div>
            <div class="row">
                ...
                <div class="large-6 columns">
                    ...
                    <div class="row">
                        <div id="combo_ta_vechiculo_tipo" class="medium-6 columns">
                            <label>Tipo del Vechiculo : 
                                <a data-open="modal_ta_vehiculo_tipo" id="vehiculo_tipo_trigger_add">Nuevo Tipo</a>
                            </label>
                            <select data-placeholder="Selecciona un tipo de Vechiculo ..." class="chosen-select" id="tasacion_vehiculo_tipo_id" name="tasacion_vehiculo_tipo_id" required>
                                <option value="0"></option>
                            </select>
                        </div>
                        <div id="combo_ta_vehiculo_marca" class="medium-6 columns">
                            <label>Marca del Vehiculo: 
                                <a data-open="modal_ta_vehiculo_marca" id="vehiculo_marca_trigger_add">Nueva Marca</a>
                            </label>
                            <select data-placeholder="Selecciona una Marca de Vechiculo ..." class="chosen-select" id="tasacion_vehiculo_marca_id" name="tasacion_vehiculo_marca_id" required>
                                <option value="0"></option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div id="combo_ta_vechiculo_modelo" class="medium-6 columns">
                            <label>Modelo del Vehiculo : 
                                <a data-open="modal_ta_vehiculo_modelo" id="vehiculo_modelo_trigger_add">Nuevo Modelo</a>
                            </label>
                            <select data-placeholder="Selecciona un modelo de Vechiculo ..." class="chosen-select" id="tasacion_vehiculo_modelo_id" name="tasacion_vehiculo_modelo_id" required>
                                <option value="0"></option>
                            </select>
                        </div>
                        <div id="combo_ta_vechiculo_traccion" class="medium-6 columns">
                            <label>Traccion del Vechiculo : 
                                <a data-open="modal_ta_vehiculo_traccion" id="vehiculo_traccion_trigger_add">Nueva Traccion</a>
                            </label>
                            <select data-placeholder="Selecciona un tipo de Traccion Vechiculo ..." class="chosen-select" id="tasacion_vehiculo_traccion_id" name="tasacion_vehiculo_traccion_id" required>
                                <option value="0"></option>
                            </select>
                        </div>
                    </div>
    ...
    <div class="reveal" id="modal_ta_vehiculo_tipo" data-reveal>
        <br>
        <h3>Nuevo Tipo de Vehiculo</h3>
        <input id="modal_ta_vehiculo_tipo_nombre" name="modal_ta_vehiculo_tipo_nombre" type="text" value="">
        <button id="modal_ta_vehiculo_tipo_save" class="button" data-close>Guardar</button>

        <button id="close_modal_ta_vehiculo_tipo" class="close-button" data-close aria-label="Close modal" type="button">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>

    <div class="reveal" id="modal_ta_vehiculo_marca" data-reveal>
        <br>
        <h3>Nueva Marca de Vehiculo</h3>
        <input id="modal_ta_vehiculo_marca_nombre" name="modal_ta_vehiculo_marca_nombre" type="text" value="">
        <button id="modal_ta_vehiculo_marca_save" class="button" data-close>Guardar</button>

        <button id="close_modal_ta_vehiculo_marca" class="close-button" data-close aria-label="Close modal" type="button">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>
    
    <div class="reveal" id="modal_ta_vehiculo_modelo" data-reveal>
        <br>
        <h3>Nuevo Modelo Vehiculo</h3>
        <input id="modal_ta_vehiculo_modelo_nombre" type="text" value="">
        <button id="modal_ta_vehiculo_modelo_save" class="button" data-close>Guardar</button>

        <button id="close_modal_ta_vehiculo_modelo" class="close-button" data-close aria-label="Close modal" type="button">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>

    <div class="reveal" id="modal_ta_vehiculo_traccion" data-reveal>
        <br>
        <h3>Nuevo Traccion de Vehiculo</h3>
        <input id="modal_ta_vehiculo_traccion_nombre" type="text" value="">
        <button id="modal_ta_vehiculo_traccion_save" class="button" data-close>Guardar</button>

        <button id="close_modal_ta_vehiculo_traccion" class="close-button" data-close aria-label="Close modal" type="button">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>
    ...
    <script type="text/javascript" src="../js/tasacion_vehiculo.js"></script>
