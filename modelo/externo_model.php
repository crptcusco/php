    ...
    public function set($nuevo_estudio_data = array()) {
        ...
        switch ($categoria) {
            case 'em_departamento':
                $this->query = "
INSERT INTO em_departamento (proyecto_id,informe_id,ubicacion, ubi_departamento_id,ubi_provincia_id,ubi_distrito_id,
...
piso_ubicacion)
VALUES('$proyecto_id','$informe_id','$ubicacion', '$ubi_departamento_id', '$ubi_provincia_id',  '$ubi_distrito_id',
...
'$piso_ubicacion')";
            ...
            case 'em_local_comercial':
                $this->query = "
INSERT INTO em_local_comercial (proyecto_id,informe_id,ubicacion, ubi_departamento_id,ubi_provincia_id,ubi_distrito_id,
estudio_fecha,terreno_area,terreno_valorunitario,valor_comercial,contacto,
telefono,mapa_latitud,mapa_longitud,zonificacion,observacion,edificacion_area,
...
'$piso_cantidad','$vista_local_id')";
            ...
            case 'em_local_industrial':
                $this->query = "
INSERT INTO em_local_industrial (proyecto_id,informe_id,ubicacion, ubi_departamento_id,ubi_provincia_id,ubi_distrito_id,
estudio_fecha,terreno_area,terreno_valorunitario,valor_comercial,contacto,
telefono,mapa_latitud,mapa_longitud,zonificacion,observacion,edificacion_area,
piso_cantidad)
VALUES('$proyecto_id','$informe_id','$ubicacion', '$ubi_departamento_id','$ubi_provincia_id',  '$ubi_distrito_id', 
...
'$piso_cantidad')";
            ...
            case 'em_terreno':
                $this->query = "
INSERT INTO em_terreno (proyecto_id,informe_id,ubicacion, ubi_departamento_id,ubi_provincia_id,ubi_distrito_id,
estudio_fecha,terreno_area,terreno_valorunitario,valor_comercial,contacto,
...
'$telefono', '$mapa_latitud', '$mapa_longitud', '$zonificacion','$observacion')";
            ...
            case 'em_casa':
                $this->query = "
INSERT INTO em_casa (proyecto_id,informe_id,ubicacion, ubi_departamento_id,ubi_provincia_id,ubi_distrito_id,
estudio_fecha,terreno_area,terreno_valorunitario,valor_comercial,contacto,
telefono,mapa_latitud,mapa_longitud,zonificacion,observacion,edificacion_area,
piso_cantidad)
VALUES('$proyecto_id','$informe_id','$ubicacion', '$ubi_departamento_id','$ubi_provincia_id',  '$ubi_distrito_id', 
